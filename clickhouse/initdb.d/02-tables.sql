...
TTL toDate(time_received) + toIntervalDay(30);
...
TTL toDate(time_received) + toIntervalDay(7);
...
PARTITION BY toDate(time_received)
ORDER BY (prefix, network, time_received)
TTL toDate(time_received) + toIntervalDay(90);
...
TTL toDate(time_received) + toIntervalDay(3);
...
(
    ...
    `icmp_packets` UInt64 CODEC(Delta, ZSTD(1)),
    `icmp_flows` UInt64 CODEC(Delta, ZSTD(1)),
    `any_min_bps` Float64 CODEC(ZSTD(1)),
    `any_max_bps` Float64 CODEC(ZSTD(1)),
    `any_p95_bps` Float64 CODEC(ZSTD(1)),
    `any_min_pps` Float64 CODEC(ZSTD(1)),
    `any_max_pps` Float64 CODEC(ZSTD(1)),
    `any_p95_pps` Float64 CODEC(ZSTD(1)),
    `tcp_min_bps` Float64 CODEC(ZSTD(1)),
    `tcp_max_bps` Float64 CODEC(ZSTD(1)),
    `tcp_p95_bps` Float64 CODEC(ZSTD(1)),
    `tcp_min_pps` Float64 CODEC(ZSTD(1)),
    `tcp_max_pps` Float64 CODEC(ZSTD(1)),
    `tcp_p95_pps` Float64 CODEC(ZSTD(1)),
    `udp_min_bps` Float64 CODEC(ZSTD(1)),
    `udp_max_bps` Float64 CODEC(ZSTD(1)),
    `udp_p95_bps` Float64 CODEC(ZSTD(1)),
    `udp_min_pps` Float64 CODEC(ZSTD(1)),
    `udp_max_pps` Float64 CODEC(ZSTD(1)),
    `udp_p95_pps` Float64 CODEC(ZSTD(1)),
    `gre_min_bps` Float64 CODEC(ZSTD(1)),
    `gre_max_bps` Float64 CODEC(ZSTD(1)),
    `gre_p95_bps` Float64 CODEC(ZSTD(1)),
    `gre_min_pps` Float64 CODEC(ZSTD(1)),
    `gre_max_pps` Float64 CODEC(ZSTD(1)),
    `gre_p95_pps` Float64 CODEC(ZSTD(1)),
    `esp_min_bps` Float64 CODEC(ZSTD(1)),
    `esp_max_bps` Float64 CODEC(ZSTD(1)),
    `esp_p95_bps` Float64 CODEC(ZSTD(1)),
    `esp_min_pps` Float64 CODEC(ZSTD(1)),
    `esp_max_pps` Float64 CODEC(ZSTD(1)),
    `esp_p95_pps` Float64 CODEC(ZSTD(1)),
    `icmp_min_bps` Float64 CODEC(ZSTD(1)),
    `icmp_max_bps` Float64 CODEC(ZSTD(1)),
    `icmp_p95_bps` Float64 CODEC(ZSTD(1)),
    `icmp_min_pps` Float64 CODEC(ZSTD(1)),
    `icmp_max_pps` Float64 CODEC(ZSTD(1)),
    `icmp_p95_pps` Float64 CODEC(ZSTD(1))
)
ENGINE = MergeTree
PARTITION BY toDate(time_received)
ORDER BY (prefix, dst_addr, dst_port, time_received)
TTL toDate(time_received) + toIntervalDay(14);
